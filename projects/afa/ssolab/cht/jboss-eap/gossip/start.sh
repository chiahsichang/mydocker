...
gosu 1002:1002 $JBOSS_HOME/bin/domain.sh -b=0.0.0.0 -bmanagement=0.0.0.0 -Djgroups.bind_addr=`hostname -i` --host-config=host-slave.xml -Djboss.domain.master.address=`echo ${DOMAIN_MASTER_HOST}`
